...
SCRIPT_DIR='/scratch/yp87/sl5952/defoca/jobs/defoca_ssl'
...
LOG_DIR="logs/defoca_ssl"
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/DS001_idx${IDX}_seed${SEED}.log"
...
python3 -u -m src.train \
  ...
  --ssl-proj-dim 8192 --ssl-hidden-dim 8192 --ssl-lambd 0.005 \
